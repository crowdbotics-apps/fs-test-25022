"""fs_test_25022 URL Configuration
...
admin.site.site_header = "fs-test"
admin.site.site_title = "fs-test Admin Portal"
admin.site.index_title = "fs-test Admin"

# swagger
api_info = openapi.Info(
    title="fs-test API",
    default_version="v1",
    description="API documentation for fs-test App",
)
